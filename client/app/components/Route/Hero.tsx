...
//       </div> */}
//       <div className="1000px:w-[40%] flex 1000px:min-h-screen items-center justify-end pt-[70px] 1000px:pt-[0] z-10">
//   <div className="w-full h-[400px] 1100px:h-[600px]">
//     <BannerModel /> 
//   </div>
// </div>
    ...
    <>
      {isLoading ? (
        ...
        <div className="w-full 1000px:flex items-center">
          ...
          {/* ⭐ LEFT SIDE — 3D MODEL instead of image */}
          <div className="1000px:w-[50%] flex 1000px:min-h-screen items-center justify-end pt-[70px] 1000px:pt-[0] z-10">
            <div className="relative w-full h-[300px] 1000px:h-[500px] 1500px:h-[650px]">
              <LaptopModel />  
              {/* If using LaptopModel: <LaptopModel /> */}
            </div>
          </div>

          {/* ⭐ RIGHT SIDE — Text, Search, Reviews */}
          <div className="1000px:w-[60%] flex flex-col items-center 1000px:mt-[0px] text-center 1000px:text-left mt-[150px]">
            <h2 className="dark:text-white text-[#000000c7] text-[30px] px-3 w-full 1000px:text-[70px] font-[600] font-Josefin py-2 1000px:leading-[75px] 1500px:w-[60%] 1100px:w-[78%]">
              {data?.layout?.banner?.title}
            </h2>
